            ...
            <div class="card card-body bg-light mt-5">
                ...
                <form action="<?php echo URLROOT; ?>/users/registerUser" method="POST">
                    <div class="form-group">
                        ...
                        <?php echo (!empty($data['errors']['name_err']))?'is-invalid' : '' ?>"  value="<?php echo $data['name'] ?>">
                        <span class="invalid-feedback"><?php echo $data['errors']['name_err'] ?></span>
                    </div>
                    <div class="form-group">
                        <label for="email">Email:</label>
                        <input type="email" name="email" class="form-control form-control-lg
                        <?php echo (!empty($data['errors']['email_err']))?'is-invalid' : '' ?>"  value="<?php echo $data['email'] ?>">
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="submit" value="Register" class="btn btn-primary col-12 mt-2">
                        </div>
                        <div class="col">
                            <a href="<?php echo URLROOT ?>/users/login" class="btn btn-secondary col-12 mt-2">Have an account? Login</a>
                        </div>
                    </div>
                </form>
            </div>
